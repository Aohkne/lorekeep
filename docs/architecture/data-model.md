...
| `mcp_server` | store + perm | 7 MCP tools + passive resources | FastMCP over stdio (default). Loads store once; enforces permission per request; writes append to journals. |
