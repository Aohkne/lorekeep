...
- [Serve & MCP](architecture/serve-mcp.md) — 7-tool core profile, passive resources, full compatibility profile, lazy-reload, journal-based writes, agent integration, sync.
